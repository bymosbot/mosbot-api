# Mosbot API Documentation

This folder contains **human-oriented** documentation for Mosbot API. Some documents are also intended to be readable by AI agents, but this is **not** a replacement for Cursor rules in `.cursor/rules/`.

## Start here

- **MosBot OS overview**: `docs/mosbot-os.md`
...
- **Database constraints**: `docs/guides/database-constraints.md`
- **Kubernetes deployment**: `docs/guides/kubernetes-deployment.md`
- **OpenClaw integrations**: `docs/openclaw/README.md`
